...
def Sand(movable_entites: list[Particle], particle_directions: ParticleDirections, board: np.ndarray, entity: Particle) -> list[Particle]:
    ...
    movable_entites = TryToMoveParticleDiagonal(movable_entites, particle_directions, entity, board)
